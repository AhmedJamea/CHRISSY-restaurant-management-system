...
{
    /// <inheritdoc />
    public partial class AddOrderManagementEntitiesAndConstraints : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_BranchTables_BranchId_TableNumber",
                        columns: x => new { x.BranchId, x.TableNumber },
                        principalTable: "BranchTables",
                        principalColumns: new[] { "BranchId", "TableNumber" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Order_ActiveTableOrder",
                table: "Orders",
                columns: new[] { "BranchId", "TableNumber" },
                unique: true,
                filter: "[Status] = 'Open' AND [TableNumber] IS NOT NULL");
        }
